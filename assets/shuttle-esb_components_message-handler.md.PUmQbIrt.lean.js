...
const __pageData = JSON.parse('{"title":"Message Handler","description":"","frontmatter":{},"headers":[],"relativePath":"shuttle-esb/components/message-handler.md","filePath":"shuttle-esb/components/message-handler.md"}');
