...
const __pageData = JSON.parse('{"title":"Components","description":"","frontmatter":{},"headers":[],"relativePath":"shuttle-esb/components/overview.md","filePath":"shuttle-esb/components/overview.md"}');
const _sfc_main = { name: "shuttle-esb/components/overview.md" };
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("h1", {
  ...
  /* @__PURE__ */ createBaseVNode("a", {
    class: "header-anchor",
    href: "#components",
    "aria-label": 'Permalink to "Components"'
  }, "​")
], -1);
