import { d as defineComponent, ao as useRouter, L as useRoute, k as onMounted, x as watch, S as nextTick, o as openBlock, c as createElementBlock } from "./framework.CfygL32k.js";
import { u as useData } from "./theme.tN7muoZb.js";
...
var s, f, p, m, v, d = {}, y = [], h = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function b(e2, t2) {
  for (var n2 in t2)
    e2[n2] = t2[n2];
  return e2;
...
var Rt = "https://cdn.jsdelivr.net/npm/search-insights@".concat("2.6.0", "/dist/search-insights.min.js"), qt = Ge(function(e2) {
      ...
      return function(e4, t3) {
        ...
        return Promise.resolve(e4(t3)).then(function(e5) {
          return Promise.all(e5.filter(function(e6) {
            ...
            if (ct("string" == typeof e6.sourceId), n4.includes(e6.sourceId))
...
function jn(e2, t2, n2) {
  return t2.map(function(t3) {
    ...
    return t3.onResolve({ source: t3, results: i2, items: a2, state: n2.getState() }), ct(a2.every(Boolean), 'The `getItems` function from source "'.concat(t3.sourceId, '" must return an array of items but returned ').concat(JSON.stringify(void 0), ".\n\nDid you forget to return items?\n\nSee: https://www.algolia.com/doc/ui-libraries/autocomplete/core-concepts/sources/#param-getitems")), { source: t3, items: a2 };
  });
}
function En(e2) {
...
var Cn, Nn, xn, Tn = null, Rn = (Cn = -1, Nn = -1, xn = void 0, function(e2) {
  var t2 = ++Cn;
...
var Kn = ["props", "refresh", "store"], Wn = ["inputElement", "formElement", "panelElement"], zn = ["inputElement"], Jn = ["inputElement", "maxLength"], $n = ["sourceIndex"], Qn = ["sourceIndex"], Zn = ["item", "source", "sourceIndex"];
function Yn(e2, t2) {
  var n2 = Object.keys(e2);
  if (Object.getOwnPropertySymbols) {
    var r2 = Object.getOwnPropertySymbols(e2);
...
var to = /(<mark>|<\/mark>)/g, no = RegExp(to.source);
function ro(e2) {
  var t2, n2, r2 = e2;
...
var No = { Read: 1, Write: 2, Any: 3 }, xo = 1, To = 2, Ro = 3;
function qo(e2) {
