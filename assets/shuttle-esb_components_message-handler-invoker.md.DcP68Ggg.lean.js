...
const __pageData = JSON.parse('{"title":"Message Handler Invoker","description":"","frontmatter":{},"headers":[],"relativePath":"shuttle-esb/components/message-handler-invoker.md","filePath":"shuttle-esb/components/message-handler-invoker.md"}');
