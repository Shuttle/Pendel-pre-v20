...
const __pageData = JSON.parse('{"title":"Message Sender","description":"","frontmatter":{},"headers":[],"relativePath":"shuttle-esb/components/message-sender.md","filePath":"shuttle-esb/components/message-sender.md"}');
